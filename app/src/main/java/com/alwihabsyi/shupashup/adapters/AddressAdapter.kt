...
import com.alwihabsyi.shupashup.databinding.AddressRvItemBinding

class AddressAdapter: RecyclerView.Adapter<AddressAdapter.AddressViewHolder>() {

    inner class AddressViewHolder(val binding: AddressRvItemBinding): RecyclerView.ViewHolder(binding.root){
        fun onBindView(address: Address, isSelected: Boolean) {
            binding.apply {
    ...
    override fun onBindViewHolder(holder: AddressViewHolder, position: Int) {
        ...
        holder.onBindView(address, selectedAddress == position)
